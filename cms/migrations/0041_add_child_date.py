...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Page.last_publish_date'
        db.add_column(u'cms_page', 'child_last_publish_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 8, 29, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Page.last_publish_date'
        db.delete_column(u'cms_page', 'child_last_publish_date')
    ...
    models = {
        ...
        'cms.page': {
            ...
            'last_publish_date': ('django.db.models.fields.DateTimeField', [], {}),
            'child_last_publish_date': ('django.db.models.fields.DateTimeField', [], {}),
            'level': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'lft': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
