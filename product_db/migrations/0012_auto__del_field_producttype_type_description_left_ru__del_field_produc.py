...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProductType.type_description_left_ru'
        db.delete_column(u'product_db_producttype', 'type_description_left_ru')

        # Deleting field 'ProductType.type_description_left'
        db.delete_column(u'product_db_producttype', 'type_description_left')

        # Deleting field 'ProductType.type_description_left_en'
        db.delete_column(u'product_db_producttype', 'type_description_left_en')


    def backwards(self, orm):
        # Adding field 'ProductType.type_description_left_ru'
        db.add_column(u'product_db_producttype', 'type_description_left_ru',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProductType.type_description_left'
        db.add_column(u'product_db_producttype', 'type_description_left',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProductType.type_description_left_en'
        db.add_column(u'product_db_producttype', 'type_description_left_en',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'product_db.product': {
            ...
            'product_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['product_db.ProductType']", 'null': 'True'}),
