...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'product_db_product', 'product_type_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['product_db.ProductType']))
    ...
    models = {
        ...
        u'product_db.product': {
            ...
            'product_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['product_db.ProductType']"}),
