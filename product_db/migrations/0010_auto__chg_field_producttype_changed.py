...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProductType.changed'
        db.alter_column(u'product_db_producttype', 'changed', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'ProductType.changed'
        db.alter_column(u'product_db_producttype', 'changed', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
