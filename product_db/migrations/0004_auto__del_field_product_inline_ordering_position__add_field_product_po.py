...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Product.inline_ordering_position'
        db.delete_column(u'product_db_product', 'inline_ordering_position')

        # Adding field 'Product.position'
        db.add_column(u'product_db_product', 'position',
                      self.gf('django.db.models.fields.IntegerField')(default=-1),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Product.inline_ordering_position'
        db.add_column(u'product_db_product', 'inline_ordering_position',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Product.position'
        db.delete_column(u'product_db_product', 'position')
