...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Product.product_type'
        db.alter_column(u'product_db_product', 'product_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['product_db.ProductType'], null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Product.product_type'
        db.alter_column(u'product_db_product', 'product_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['product_db.ProductType']))
