...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Product.position_in_list'
        db.add_column(u'product_db_product', 'position_in_list',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Product.position_in_list'
        db.delete_column(u'product_db_product', 'position_in_list')
