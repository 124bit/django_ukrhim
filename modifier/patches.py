...
Site.add_to_class('company', CharField(_('Price field attrs'),help_text=_('Site company will show in header country-company selection'),max_length=70))
Site.add_to_class('country', CharField(_('Price field attrs'),help_text=_('Site country will show in header country-company selection'),max_length=70))
