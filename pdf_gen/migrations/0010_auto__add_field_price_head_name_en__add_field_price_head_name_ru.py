...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Price.head_name_en'
        db.add_column(u'pdf_gen_price', 'head_name_en',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Price.head_name_ru'
        db.add_column(u'pdf_gen_price', 'head_name_ru',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Price.head_name_en'
        db.delete_column(u'pdf_gen_price', 'head_name_en')

        # Deleting field 'Price.head_name_ru'
        db.delete_column(u'pdf_gen_price', 'head_name_ru')
